                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <span> Skill </span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="education.php">Skill</a></li>
                                    <li><a href="education_edit.php">Add Skills</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="services.php">Educations</a></li>
                                    <li><a href="service_add.php">Add Educations</a></li>
                                </ul>
                            </li>
                    ...
                    <nav class="navbar-custom">
                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.php">Workfolio</a></li>
