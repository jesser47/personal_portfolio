                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card-box tilebox-one">
                                            <i class="fa fa-cogs  float-right text-muted"></i>
                                            <h6 class="text-muted text-uppercase mt-0">skills</h6>
                                            <h2 class=""><span data-plugin="counterup">
                                              <?php
                                              $result = $dbcon->query("SELECT COUNT(*) AS total_services FROM education_informations");
                                              $row = $result->fetch_assoc();
                                              echo $row['total_services']; 
                                              ?>
                                              </span></h2>
                                        </div>
                                        <a class="btn btn-sm btn-block btn-success" href="education.php">all skills</a>
                                    </div><!-- end col -->
